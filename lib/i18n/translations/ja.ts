...
export const ja: TranslationKeys = {
  ...
  profile: {
    ...
    github: 'GitHub',
    statistics: '統計',
    relationshipWithYou: 'あなたとの関係',
    mutualFollowers: '共通のフォロワー ({count}人)',
    mutualInterests: '共通の興味',
    interactions: 'インタラクション',
    mutualVotes: '相互アップボート',
    mutualComments: '相互コメント',
    recentActivity: '最近のアクティビティ',
    activityComingSoon: 'アクティビティ機能は現在開発中です',
    stats: {
      posts: '投稿',
      votes: '獲得投票',
      comments: 'コメント',
  ...
  errors: {
    ...
    profileCreationFailed: 'プロフィールの作成に失敗しました',
